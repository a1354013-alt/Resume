  ...
  const sections = useMemo<BiographySection[]>(
    () => [
      ...
      },
      {
        ...
        subtitle: "讓系統真正落地",
        paragraphs: [
          "實務專案中，曾與團隊參與皇昌營造、德昌營造等上市櫃企業的 ERP 系統導入。這類專案最具挑戰性的往往是歷史資料轉換；面對格式與品質參差不齊的舊資料，需要配合實際作業流程進行清理、比對與驗證，協助新舊系統順利銜接。",
          "此外，也曾前往格瑞、富旺、精銳與惠宇建設等現場，參與教育訓練、操作說明與專案簡報。這些第一線溝通經驗，結合過去在傳統工廠的歷練，使我在專案中更能掌握不同角色的需求差異，並在開發階段預先安排防錯設計，協助系統在真實環境中穩定運作。",
        ],
        bullets: [
          {
            label: "導入與協作重點",
      ...
      },
      {
        ...
        title: "AI 技術進修與未來方向",
        paragraphs: [
          "為了將系統開發與前瞻技術結合，目前就讀國立彰化師範大學人工智慧科技應用碩士學位學程，碩士論文口試已通過，現階段持續進行論文修訂與學位審核，並專注於 AI 物件偵測與影像辨識領域。",
